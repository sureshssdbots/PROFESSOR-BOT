...
async def premium_callback(client, callback_query):
    ...
    image_url = "https://graph.org/file/8da1275a1c708d6951295-604038810b7f622d41.jpg"  # यहां अपनी इमेज का URL डालें
...
async def all_plans_callback(client, callback_query):
    username = callback_query.from_user.username
    image_url = "https://graph.org/file/22f632ce2f54cb2f5fe86-dade858bfce22ab65c.jpg"  # यहां अपनी इमेज का URL डालें


    buttons = [
    [
        InlineKeyboardButton("📸 Send Screenshot", url="https://t.me/suresh_jaat_7")  # यहाँ अपनी टेलीग्राम आईडी डालें
    ]
    ]
